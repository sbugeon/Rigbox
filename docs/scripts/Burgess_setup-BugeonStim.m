...
stimWindow.Calibration = S.stimWindow.Calibration;
...
% when looking back at old experiments n the future:
...
lightIn = 'ai1'; % The input channel of the photodiode used to measure screen
clockIn = 'ai0'; % The clocking pulse input channel
clockOut = 'port0/line12'; % The clocking pulse output channel
...
% % Synchronization failiures indicate that there tareing or rigbox kering may
